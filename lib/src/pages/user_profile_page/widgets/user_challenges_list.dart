...
class UserChallengesList extends StatelessWidget {
  const UserChallengesList({Key key, @required this.user}) : super(key: key);
    ...
    return Consumer<UserStore>(
      builder: (context, userStore, child) {
        return FutureBuilder(
          future: ChallengeService.instance.getDoneChallengesForUser(userStore.authentificationHeader, user.id),
